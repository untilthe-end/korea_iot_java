...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        Integer a = null;
        // int z = a; // .NullPointerException
        int z = (a != null) ? a.intValue() : 0; // 안전하게 기본값을 '0'으로 처리
        ...
        // int parseIntValue2 = Integer.parseInt("abc"); //.NumberFormatException
        ...
        int result = myInteger.compareTo(anotherInt); // 호출 객체 (a)가 작으면 -1, 크면 1, 같으면 0
